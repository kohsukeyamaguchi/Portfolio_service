    ...
    if (empty($err_msg)) {
      ...
      try {
        ...
        if ($stmt && array_shift($result)) {
          ...
          //メールを送信
          $from = 'tshantian948@gmail.com';
          $to = $email;
          $subject = '【パスワード再発行認証】｜PORTFOLIOSERVICE';
...
パスワード再発行認証キー入力ページ：https://xs0553.xsrv.jp/portfolio_service/pass_remindRecieve.php
認証キー：{$auth_key}
※認証キーの有効期限は30分となります
...
////////////////////////////////////////
ポートフォリオサービスカスタマーセンター
URL  http://xxx.com/
E-mail tshantian948@gmail.com
////////////////////////////////////////
EOT;
          ...
          header("Location:pass_remindRecieve.php"); //認証キー入力ページへ
